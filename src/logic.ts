...
function calculateNextMove(gameState: GameState, playBoard: PlayBoard): string{
    ...
    if(possibleMoves[0] && possibleMoves[1] && possibleMoves[2] && possibleMoves[3]){
        ...
        //:down and right:
        console.log("it's possible to move down and right!");
        if(fieldsAroundCurrentCoord[3].score < fieldsAroundCurrentCoord[1].score){//changed index
            console.log("tell snake to move right!");
            returnStatement = "right"
        }else{
            console.log("tell snake to move down!");
        ...
        //up and left:
        console.log("it's possible to move up and left!");
        if(fieldsAroundCurrentCoord[2].score < fieldsAroundCurrentCoord[0].score){//changed index
            console.log("tell snake to move left!");
            returnStatement = "left"
        }else{
            console.log("tell snake to move up!");
        ...
        //up and down:
        if(fieldsAroundCurrentCoord[1].score < fieldsAroundCurrentCoord[0].score){//changed index
            console.log("tell snake to move up!");
            returnStatement = "up"
        }else{
            console.log("tell snake to move down!");
        ...
        //left and right:
        if(fieldsAroundCurrentCoord[3].score < fieldsAroundCurrentCoord[2].score){//changed index
            console.log("tell snake to move right!");
            returnStatement = "right";
        }else{
            returnStatement = "left";
